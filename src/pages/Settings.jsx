      ...
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="secondColumn col col-10 offset-1 col-lg-6 offset-lg-0">
            <div className="d-flex justify-content-between">
              ...
              <p className="text-info fw-semibold mb-1">Change account email</p>
            </div>
            <div className="d-flex justify-content-between">
            ...
            <div className="d-flex justify-content-between">
              ...
              <p className="text-info fw-semibold mb-1">Change phone number</p>
            </div>
            ...
            <div className="d-flex justify-content-between">
              ...
              <p className="text-info fw-semibold mb-1">Update payment info</p>
            </div>
            <div className="d-flex justify-content-between">
              <p></p>
        ...
        <div className="row">
          ...
          <div className="secondColumn col col-10 offset-1 col-lg-6 offset-lg-0">
            ...
            <div className="d-flex justify-content-between">
              <p className="text-info fw-semibold mb-1">Sign out all devices</p>
            </div>
          </div>
        </div>
        <div className="row">
        ...
        <div className="row">
          ...
          <div className="secondColumn col col-10 offset-1 col-lg-6 offset-lg-0">
            ...
            <div className="d-flex justify-content-between">
              <p className="text-info fw-semibold mb-1">Subtitle appearance</p>
            </div>
          </div>
        </div>
      </div>
